...
public class AnalogEncoder implements Sendable, AutoCloseable {
   ...
   * position relative
   * to the last reset. This could potentially be negative, which needs to be
   * accounted for.
   *
   * <p>
   ...
   * to determine the
   * distance driven based on the rotation value from the encoder. Set this value
   * based on how far
   * the mechanism travels in 1 rotation of the encoder, and factor in gearing
   * reductions following
   * the encoder shaft. This distance can be in any units you like, linear or
   * angular.
   *
