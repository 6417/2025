...
public final class Constants {
    ...
    public static final class SwerveDrive {
        ...
        public static final double maxTurnSpeed = 30;//Math.hypot(moduleXoffset, moduleYoffset) * maxSpeed / (Math.PI * 2); // rps
        ...
        static {
            ...
            configs[LOC_FL].absEncoderOffset = 0.00241;
            ...
            configs[LOC_FR].absEncoderOffset = 0.001448;
            ...
            configs[LOC_RL].absEncoderOffset = 0.986;
            ...
            configs[LOC_RR].absEncoderOffset = 0.114;
        }
    } 
}
