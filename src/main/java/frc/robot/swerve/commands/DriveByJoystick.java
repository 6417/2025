...
import frc.robot.swerve.SwerveDrive2025;

/* You should consider using the more terse Command factories API instead https://docs.wpilib.org/en/stable/docs/software/commandbased/organizing-command-based.html#defining-commands */
public class DriveByJoystick extends Command {
  private final SwerveDrive2025 mDrive = SwerveDrive2025.getInstance();
  ...
  public void initialize() {
    ...
    double xSpeed = mSlewX.calculate((mX.getAsDouble()) * DriveConstants.maxSpeed) * scalar;
    double ySpeed = mSlewY.calculate((mY.getAsDouble()) * DriveConstants.maxSpeed) * scalar;
    double rotation = mSlewRot.calculate((mRotation.getAsDouble()) * DriveConstants.maxAngularSpeedRadPerSec) * scalar;
